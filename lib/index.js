...
Eyeglass.prototype = {
  ...
  sassPathFromEnv: function() {
    if (process.env.SASS_PATH) {
      return process.env.SASS_PATH.split(path.delimiter).map(function(p) {
  ...
  normalizeOptions: function(options) {
    ...
    options.includePaths = options.includePaths.map(function(p) {
