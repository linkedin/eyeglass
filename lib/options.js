...
function Options(eyeglass, options, Eyeglass, sassArg) {
...
function defaultEyeglassOptions(options, Eyeglass) {
  // default root dir
  ...
  options.engines.eyeglass = defaultValue(options.engines.eyeglass, Eyeglass);
  // default assets
...
function getSassOptions(eyeglass, options, Eyeglass, sassArg) {
  ...
  var eyeglassOptions =  merge({}, eyeglassOptionsFromNodeSassArg(sassArg), sassOptions.eyeglass);
  ...
  defaultEyeglassOptions(eyeglassOptions, Eyeglass);
