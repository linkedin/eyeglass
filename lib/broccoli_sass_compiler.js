...
var parallelWork = require("../lib/parallel-work");
var os = require("os");
...
BroccoliSassCompiler.prototype.compileTree = function(srcPath, files, destDir) {
  ...
  return queue(worker, files, numConcurrentCalls)
...
BroccoliSassCompiler.prototype.compileSassFile = function(srcPath, sassFilename, destDir) {
  console.log("CALLED compileSassFile");
  var self = this;
...
var writeFile = RSVP.denodeify(fs.writeFileSync);
...
BroccoliSassCompiler.prototype.build = function() {
  ...
  function doBuild() {
    ...
    return self.compileTree(inputPath, treeFiles, outputPath).then(function() {
      if (!self.currentTree) {
