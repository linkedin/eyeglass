...
module.exports = class BroccoliSassCompiler extends BroccoliPlugin {
  ...
  handleCacheHit(details, inputAndOutputFiles) {
    ...
    return files.map(file => {
      ...
      this.writeDataToFile(cachedFile, outputFile, new Buffer(data, "base64"));
    });
  }

  writeDataToFile(cachedFile, outputFile, data) {
  ...
  handleSuccess(details, result) {
    ...
    this.writeDataToFile(cachedFile, outputFile, result.css);
