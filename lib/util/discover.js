...
function getEyeglassModuleDef(dir) {
  ...
  var packageDef = getPackage(dir);
  if (packageDef && isEyeglassPlugin(packageDef)) {
    var modDef = resolvedModuleDef(packageDef, packageFile, dir);
    return modDef;
  }
}
...
module.exports.getEyeglassModuleDef = getEyeglassModuleDef;
