...
function resolveAssetToUri(eyeglass, sass, sassUtils, registeredAssetsMap, relativePathString) {
  var data = resolveAsset(sass, sassUtils, registeredAssetsMap, relativePathString);

  if (data) {
    // sassUtils.assertType(data, "map");
    var uri = data.coerce.get("uri");
    var globalHttpPrefix = eyeglass.options.assetsHttpPrefix ?
                         "/" + eyeglass.options.assetsHttpPrefix : "";
    return globalHttpPrefix + "/" + uri;
  }
}
...
module.exports = function(eyeglass, sass) {
  ...
  mainCollection.resolveAssetToUri = function(registeredAssetsMap, relativePathString) {
    return resolveAssetToUri(eyeglass, sass, sassUtils, registeredAssetsMap, relativePathString);
  };
